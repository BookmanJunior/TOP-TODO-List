...
const inbox = (0,_project__WEBPACK_IMPORTED_MODULE_0__["default"])("Inbox");

// For testing
const work = (0,_project__WEBPACK_IMPORTED_MODULE_0__["default"])("Work");
const school = (0,_project__WEBPACK_IMPORTED_MODULE_0__["default"])("School");

const test1 = (0,_toDo__WEBPACK_IMPORTED_MODULE_1__["default"])("test", new Date("2023-05-16"), "high", "checked");
const test2 = (0,_toDo__WEBPACK_IMPORTED_MODULE_1__["default"])("test2", new Date(), "medium");
const test3 = (0,_toDo__WEBPACK_IMPORTED_MODULE_1__["default"])("test3", new Date("2023-04-12"), "low");
...
const screenController = () => {
  ...
  let currentProject = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].getProject("Inbox");

  const renderTask = (task) => {
    const taskContainer = (0,_toDoComponent__WEBPACK_IMPORTED_MODULE_3__["default"])(
      task.title,
      task.dueDate,
      task.priority,
      task.status,
  ...
  const removeTask = (e) => {
    ...
    const selectedProject = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].getTasksProject(tasksId);
  ...
  const renderUserProjects = () => {
    ...
    allUserProjects.forEach((project) => {
      projectsContainer.appendChild((0,_projectComponent__WEBPACK_IMPORTED_MODULE_5__["default"])(project.title));
    });
  };
  ...
  const switchProject = (e) => {
    ...
    currentProject = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].getProject(selectedProject);
  ...
  const removeProject = (e) => {
    ...
    _projects__WEBPACK_IMPORTED_MODULE_0__["default"].removeProject(projectsTitle);
    parentContainer.remove();

    // switch to default Inbox folder if active project was deleted
    if (parentContainer.classList.contains("active")) {
      e.target.closest("li").classList.remove("active");
      switchProject(e, _taskController__WEBPACK_IMPORTED_MODULE_1__["default"].getAllTasks());
    }
  };
  ...
  completedTasksFolder.addEventListener("click", (e) => {
    switchFolder(e, _taskController__WEBPACK_IMPORTED_MODULE_1__["default"].getCompletedTasks());
  });
  todayFolder.addEventListener("click", (e) => {
    switchFolder(e, _taskController__WEBPACK_IMPORTED_MODULE_1__["default"].getTodaysTasks());
  });
  thisWeeksFolder.addEventListener("click", (e) => {
    switchFolder(e, _taskController__WEBPACK_IMPORTED_MODULE_1__["default"].getThisWeeksTasks());
  });
  taskForm.addEventListener("submit", generateNewTask);
  tasksContainer.addEventListener("click", (e) => {
    if (e.target.matches(".edit-btn")) {
      const taskElement = e.target.closest(".task");
      taskElement.replaceWith((0,_toDoFormComponent__WEBPACK_IMPORTED_MODULE_4__["default"])("edit-form"));
    }
  });
  tasksContainer.addEventListener("click", (e) => {
    if (e.target.matches(".delete-btn")) {
...
function dueDateElement(dueDate) {
  ...
  dateComponent.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(dueDate), "MMM do");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ toDoFormComponent)
/* harmony export */ });
function toDoFormComponent(elementClass) {
