...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "loadLocalData": () => (/* binding */ loadLocalData),
/* harmony export */   "updateLocalData": () => (/* binding */ updateLocalData)
/* harmony export */ });
...
function updateLocalData() {
  if (isLocalStorageAvailable()) {
    localStorage.setItem("projects", JSON.stringify(_projects__WEBPACK_IMPORTED_MODULE_0__["default"].list));
  }
}
...
function getLocalData() {
  ...
  if (localData) {
    ...
    localData.forEach((project) => {
      const currentProject = (0,_project__WEBPACK_IMPORTED_MODULE_1__["default"])(project.title);
      const currentProjectTasks = project.tasks;
      currentProjectTasks.forEach((task) => {
        const currentTask = (0,_toDo__WEBPACK_IMPORTED_MODULE_2__["default"])(
          task.title,
          task.dueDate,
          task.priority,
          task.status,
    ...
    _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList = restoredProjects;
    return;
  }
...
/***/ "./src/modules/projectComponent.js":
/*!*****************************************!*\
  !*** ./src/modules/projectComponent.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _svgGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./svgGenerator */ "./src/modules/svgGenerator.js");
...
function projectComponent(projectTitle) {
  ...
  deleteBtn.appendChild((0,_svgGenerator__WEBPACK_IMPORTED_MODULE_0__.deleteIcon)());
  editBtn.appendChild((0,_svgGenerator__WEBPACK_IMPORTED_MODULE_0__.editIcon)());
...
const inbox = (0,_project__WEBPACK_IMPORTED_MODULE_0__["default"])("Inbox"); // default project
const localDataSupport = (0,_toDo__WEBPACK_IMPORTED_MODULE_1__["default"])(
  "Add local storage support",
  new Date("2023-03-25"),
  "high",
  "completed"
);
const statsTask = (0,_toDo__WEBPACK_IMPORTED_MODULE_1__["default"])("Add stats update", new Date(), "high");
...
class Projects {
  ...
  static addProject(project) {
    const newProject = (0,_project__WEBPACK_IMPORTED_MODULE_0__["default"])(project);
...
/* harmony export */ });
/* harmony import */ var _projects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./projects */ "./src/modules/projects.js");
/* harmony import */ var _taskController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./taskController */ "./src/modules/taskController.js");
/* harmony import */ var _toDo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./toDo */ "./src/modules/toDo.js");
/* harmony import */ var _toDoComponent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./toDoComponent */ "./src/modules/toDoComponent.js");
/* harmony import */ var _toDoFormComponent__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./toDoFormComponent */ "./src/modules/toDoFormComponent.js");
/* harmony import */ var _projectComponent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./projectComponent */ "./src/modules/projectComponent.js");
/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./localStorage */ "./src/modules/localStorage.js");
...
const screenController = () => {
  ...
  const renderTask = (task) => {
    const taskComponent = (0,_toDoComponent__WEBPACK_IMPORTED_MODULE_3__["default"])(task);
    tasksContainer.appendChild(taskComponent);
  };

  const generateNewTask = (e) => {
    e.preventDefault();
    const newTask = (0,_toDo__WEBPACK_IMPORTED_MODULE_2__["default"])(
      taskForm.taskTitle.value,
      taskForm.dueDate.value,
      taskForm.priority.value
    );
    const newTaskContainer = (0,_toDoComponent__WEBPACK_IMPORTED_MODULE_3__["default"])(newTask);
    ...
    (0,_localStorage__WEBPACK_IMPORTED_MODULE_6__.updateLocalData)();
    taskForm.reset();
  };
  ...
  const editTask = (e) => {
    ...
    const toDoEditForm = (0,_toDoFormComponent__WEBPACK_IMPORTED_MODULE_4__["default"])(currentTask);
  ...
  const renderProject = (project) => {
    projectsContainer.appendChild((0,_projectComponent__WEBPACK_IMPORTED_MODULE_5__.projectComponent)(project));
  };
  ...
  const addProject = (e) => {
    ...
    if (_projects__WEBPACK_IMPORTED_MODULE_0__["default"].checkForDuplicateProjects(newProjectTitle)) {
      return;
    }

    _projects__WEBPACK_IMPORTED_MODULE_0__["default"].addProject(newProjectTitle);
    (0,_localStorage__WEBPACK_IMPORTED_MODULE_6__.updateLocalData)();
  ...
  const editUserProject = (e) => {
    ...
    currentProject = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].getProject(projectTitle);
    const newTaskForm = (0,_projectComponent__WEBPACK_IMPORTED_MODULE_5__.editProjectComponent)(currentProject.title);
  ...
  const saveEditedProject = (e) => {
    ...
    if (_projects__WEBPACK_IMPORTED_MODULE_0__["default"].checkForDuplicateProjects(projectEditFormValue)) {
      return;
    }
  ...
  const removeProject = (e) => {
    ...
    const project = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].getProject(projectsTitle);

    _projects__WEBPACK_IMPORTED_MODULE_0__["default"].removeProject(project.title);
    parentContainer.remove();
    (0,_localStorage__WEBPACK_IMPORTED_MODULE_6__.updateLocalData)();

    // switch to default Inbox folder if active project was deleted
    if (parentContainer.classList.contains("active")) {
      currentProject = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].getProject("Inbox");
      switchLink(currentProject.title);
    }
  ...
  const init = () => {
    (0,_localStorage__WEBPACK_IMPORTED_MODULE_6__.loadLocalData)(); // loads data from local storage if available.
    currentProject = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].getProject("Inbox"); // default project on load
    renderAllTasks();
    renderUserProjects();
    noTasksAvailableSign();
  ...
  function renderEditedTask() {
    ...
    const taskContainer = (0,_toDoComponent__WEBPACK_IMPORTED_MODULE_3__["default"])(currentTask);
    taskContainer.dataset.state = "added"; // disable entrance animation
    const isTodaysTask = _taskController__WEBPACK_IMPORTED_MODULE_1__["default"].getTodaysTasks()
      .some(({ id }) => id === taskContainer.dataset.id);
    const isThisWeeksTask = _taskController__WEBPACK_IMPORTED_MODULE_1__["default"].getThisWeeksTasks()
      .some(({ id }) => id === taskContainer.dataset.id);
  ...
  function getTasksElement(e) {
    ...
    const tasksProject = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].getTasksProject(tasksId);
  ...
  function renderAllTasks() {
    _taskController__WEBPACK_IMPORTED_MODULE_1__["default"].getAllTasks().forEach((task) => {
      renderTask(task);
    });
  }
  ...
  function renderUserProjects() {
    // skip inbox project
    const allUserProjects = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].list.slice(1);
  ...
  function refreshTasks() {
    const defaultFolderFunctions = {
      Inbox: _taskController__WEBPACK_IMPORTED_MODULE_1__["default"].getAllTasks(),
      Today: _taskController__WEBPACK_IMPORTED_MODULE_1__["default"].getTodaysTasks(),
      Completed: _taskController__WEBPACK_IMPORTED_MODULE_1__["default"].getCompletedTasks(),
      "This Week": _taskController__WEBPACK_IMPORTED_MODULE_1__["default"].getThisWeeksTasks(),
    };
  ...
  function switchLink(linkTitle) {
    currentProject = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].getProject(linkTitle) ?? linkTitle;
    refreshTasks();
    noTasksAvailableSign();
...
/* harmony export */   "svgGenerator": () => (/* binding */ svgGenerator)
/* harmony export */ });
...
class taskController {
  static getAllTasks() {
    return _projects__WEBPACK_IMPORTED_MODULE_0__["default"].list.reduce((tasks, project) => {
  ...
  static getTodaysTasks() {
    ...
    const todaysTask = this.getAllTasks().filter((task) =>
      (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dateToCompare, new Date(task.dueDate))
    );
    return todaysTask;
  }
  ...
  static getThisWeeksTasks() {
    ...
    const thisWeeksTasks = this.getAllTasks().filter((task) =>
      (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dateToCompare, new Date(task.dueDate))
    );
...
function ToDo(
  ...
  priority,
  status = "uncompleted",
  id = (0,_idGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])()
) {
  return {
    get title() {
      return title;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ generateTaskComponent)
/* harmony export */ });
...
function dueDateElement(dueDate = "") {
  ...
  dateComponent.textContent = dueDate
    ? (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(dueDate), "MMM do")
    : "No Due Date";
...
/***/ "./src/modules/toDoFormComponent.js":
/*!******************************************!*\
  !*** ./src/modules/toDoFormComponent.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ generateToDoFromComponent)
/* harmony export */ });
/* harmony import */ var _svgGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./svgGenerator */ "./src/modules/svgGenerator.js");


function generateToDoFromComponent(task) {
...
function rightSideWrapper() {
  ...
  const addBtn = btnFactory("save-btn", (0,_svgGenerator__WEBPACK_IMPORTED_MODULE_0__.addIcon)());
  const cancelBtn = btnFactory("cancel-btn", (0,_svgGenerator__WEBPACK_IMPORTED_MODULE_0__.cancelIcon)());
...
const app = (0,_modules_screenController__WEBPACK_IMPORTED_MODULE_0__["default"])();
