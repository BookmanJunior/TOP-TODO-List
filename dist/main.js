...
const screenController = () => {
  ...
  const switchFolder = (e, fn) => {
    ...
    tasksContainer.textContent = "";
    activeFolder = currentFolder.firstElementChild.textContent;
  ...
  const removeProject = (e) => {
    ...
    if (activeFolder === "Today") {
      tasksContainer.textContent = "";
      _taskController__WEBPACK_IMPORTED_MODULE_1__["default"].getTodaysTasks().forEach((task) => {
        renderTask(task);
      });
    }
  };
